...
/*
 * Initialize a pkt structure.  If data is not NULL, it should be a pointer
 * to a TCP segment, including its header.
 *
 * This can be used to make a copy of a packet, existingpkt, by invoking:
 *     packet newpacket;
 *     initPacket(&newpacket, existingpkt.data, existingpkt.len);
 */
